    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div>
                    <h4 class="text-center m-5">Doctor Register</h4>
                 <?php 
                 if(isset($_POST['register'])){
                    ...
                    if(count($error)==0)
                    {
                        ...
                        (firstname,lastname,username,email,gender,country,phonenumber,password,salary,status,date_reg,profile) 
                        VALUES ('$fname','$lname','$uname','$email','$gender','$country','$phone','$password','0','pending',NOW(),'doctor1.jpg')";
                 ...
                 ?>
                    ...
                    <p>I have an account?<a href="doctorlogin.php" style="text-decoration:none; color:brown;">Login here!</a></p>
