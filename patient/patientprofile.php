            ...
            <div class="col-md-2" style="margin-left: -30px;">
             ...
             if(isset($_POST['update'])){
                 ...
                 if(empty($image)){
                     ...
                     $sql="UPDATE patients SET profile='$image' WHERE username='$ad'";
             ...
             <div class="col-md-4">
                 ...
                 if(isset($_POST['updatename'])){
                     ...
                     $sql="UPDATE patients SET username='$username' WHERE username='$ad'";
                     $result=mysqli_query($connect,$sql);
                     if($result){
                 ...
                 if(isset($_POST['updatepass']))

                   {
                     ...
                     if(count($error)==0)
                     {
                        $sql1="UPDATE patients SET password='$newpass' WHERE username='$ad'";
